...
const
  ...
  CRC32Table: CRCTable = ($00000000, $77073096, $EE0E612C, $990951BA, $076DC419,
    ...
    $83D385C7, $136C9856, $646BA8C0, $FD62F97A, $8A65C9EC, $14015C4F, $63066CD9,
    $FA0F3D63, $8D080DF5,
    ...
    $D3D6F4FB, $4369E96A, $346ED9FC, $AD678846, $DA60B8D0, $44042D73, $33031DE5,
    $AA0A4C5F, $DD0D7CC9,
    ...
    $D6D6A3E8, $A1D1937E, $38D8C2C4, $04FDFF252, $D1BB67F1, $A6BC5767,
    $3FB506DD, $048B2364B, $D80D2BDA, $AF0A1B4C, $36034AF6, $041047A60,
    ...
    $18B74777, $88085AE6, $FF0F6A70, $66063BCA, $11010B5C, $8F659EFF, $F862AE69,
    $616BFFD3, $166CCF45,
  ...
  try
    ...
    begin
      if Assigned(InFile) then
        InFile.Free;
      ShowMessage(Format('При обработке файла [%s] возникла ' + 'oшибка [%s]',
        [FileName, E.Message]));
    end;
  end;
  Result := not Crc32;
